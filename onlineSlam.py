...
#    for k in range(len(data)):
        ...
        expandParams = []
        expandParams.extend([0, 1])
        expandParams.extend([i for i in range(4, dim -1)])
        print 'dimx', Omega.dimx
        Omega = Omega.expand(dim + 2, dim + 2, expandParams)
        Xi = Xi.expand(dim + 2, 1, expandParams, [0])
#        Xi.show()
        for b in range(4):
        ...
        print 'Before', Omega.show()
        Omega = Omega.take([i for i in range(2, dim -1)])
        print 'After', Omega.show()
        print 'final dimx', Omega.dimx
