...
def slam(data, N, num_landmarks, motion_noise, measurement_noise):
    ...
    omega.value[0][0] = 1
    omega.value[1][1] = 1
    startValue = world_size / 2
    xi.value[0][0] = startValue
    xi.value[1][0] = startValue

    measurementWeight = 1 / measurement_noise
    motionWeight = 1 / motion_noise
    ...
    for i in range(len(data)):
        ...
        for j in range(len(measurement)):
            ...
            for b in range(2):
                omega.value[n + b][n + b] += measurementWeight
                omega.value[m + b][m + b] += measurementWeight
                omega.value[m + b][n + b] -= measurementWeight
                omega.value[n + b][m + b] -= measurementWeight
                xi.value[n + b][0] -= measurement[i][b + i] / measurement_noise
                xi.value[m + b][0] += measurement[i][b + i] / measurement_noise

        for b in range(4):
            omega.value[n + b][n + b] += motionWeight
        for b in range(2):
            omega.value[n + b][n + b + 2] -= motionWeight
